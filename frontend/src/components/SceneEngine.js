...
const SKINS = [
  ...
  { id: 'aromatherapy-spa', name: 'Aromatic Resonance Spa', category: 'Contextual', accent: '#F59E0B', cardTint: 'rgba(245,158,11,0.05)', borderTint: 'rgba(245,158,11,0.12)', url: 'https://images.unsplash.com/photo-1581514439794-f9777f7c22eb?w=1920&q=90', overlay: 'rgba(0,0,0,0.2)' },
