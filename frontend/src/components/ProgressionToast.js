...
const SOURCE_META = {
  ...
  HVAC_Skill:          { label: 'HVAC Work',         color: '#06B6D4', icon: Shield },
  Robotics_Skill:      { label: 'Robotics',          color: '#8B5CF6', icon: Shield },
  FirstAid_Skill:      { label: 'First Aid',         color: '#EF4444', icon: Shield },
  Hermetics_Skill:     { label: 'Hermetic Study',    color: '#D4AF37', icon: Shield },
  Speaking_Skill:      { label: 'Public Speaking',   color: '#F59E0B', icon: Shield },
  Philosophy_Skill:    { label: 'Philosophy',        color: '#8B5CF6', icon: Shield },
  Pedagogy_Skill:      { label: 'Pedagogy',          color: '#3B82F6', icon: Shield },
  Anatomy_Skill:       { label: 'Anatomy',           color: '#EF4444', icon: Shield },
  Machining_Skill:     { label: 'Machining',         color: '#6B7280', icon: Shield },
