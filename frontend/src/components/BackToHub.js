...
const RELATED = {
  ...
  '/workshop/masonry': [
    ...
    { label: 'Welding', route: '/workshop/welding' },
    { label: 'Trade Passport', route: '/trade-passport' },
    { label: 'Trade Circle', route: '/trade-circle' },
  ],
  '/workshop/carpentry': [
    { label: 'Masonry', route: '/workshop/masonry' },
  ...
  '/workshop/electrical': [
    { label: 'Plumbing', route: '/workshop/plumbing' },
    { label: 'HVAC', route: '/workshop/hvac' },
    { label: 'Trade Passport', route: '/trade-passport' },
    { label: 'Robotics', route: '/workshop/robotics' },
  ],
  '/workshop/plumbing': [
    { label: 'Electrical', route: '/workshop/electrical' },
    { label: 'Landscaping', route: '/workshop/landscaping' },
    { label: 'Trade Passport', route: '/trade-passport' },
    { label: 'HVAC', route: '/workshop/hvac' },
  ],
  ...
  '/workshop/nursing': [
    { label: 'Elderly Care', route: '/workshop/eldercare' },
    { label: 'Child Care', route: '/workshop/childcare' },
    { label: 'First Aid', route: '/workshop/first_aid' },
    { label: 'Anatomy', route: '/workshop/anatomy' },
  ],
  '/workshop/eldercare': [
    { label: 'Nursing', route: '/workshop/nursing' },
    { label: 'Child Care', route: '/workshop/childcare' },
  ...
  '/workshop/bible': [
    { label: 'Meditation', route: '/workshop/meditation' },
    { label: 'Hermetics', route: '/workshop/hermetics' },
    { label: 'Philosophy', route: '/workshop/philosophy' },
    { label: 'Oracle', route: '/oracle' },
  ],
  '/workshop/welding': [
    { label: 'Masonry', route: '/workshop/masonry' },
    { label: 'Automotive', route: '/workshop/automotive' },
    { label: 'Machining', route: '/workshop/machining' },
    { label: 'Trade Passport', route: '/trade-passport' },
  ],
  '/workshop/automotive': [
    { label: 'Welding', route: '/workshop/welding' },
