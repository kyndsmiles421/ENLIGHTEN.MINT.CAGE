...
export default function NotificationSettings({ onClose }) {
  ...
  return (
    <motion.div
      ...
      style={{ background: isLight ? 'rgba(255,255,255,0.96)' : 'rgba(0,0,0,0)', backdropFilter: 'none', border: `1px solid ${isLight ? 'rgba(30,27,46,0.08)' : 'rgba(255,255,255,0.06)'}`, boxShadow: isLight ? '0 16px 48px rgba(30,27,46,0.12)' : '0 20px 60px rgba(0,0,0,0.15)' }}
