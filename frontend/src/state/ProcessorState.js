...
export const MODULE_REGISTRY = {
  ...
  // V1.1.1 — Bulk pillar wiring (98 routes). Direct page lazy-imports
  // (V68.97 pattern) so we don't create 98 redundant adapter files.
  // Each entry maps a Hub pillar route -> in-place pull() of the page.
  ACADEMY:                     React.lazy(() => import('../pages/AcademyPage')),
  ANALYTICS:                   React.lazy(() => import('../pages/Analytics')),
  AR_PORTAL:                   React.lazy(() => import('../pages/ARPortalPage')),
  ARCHIVES:                    React.lazy(() => import('../pages/Archives')),
  AVATAR_GALLERY:              React.lazy(() => import('../pages/AvatarGallery')),
  BOTANY:                      React.lazy(() => import('../pages/Botany')),
  BOTANY_ORBITAL:              React.lazy(() => import('../pages/BotanyOrbital')),
  CERTIFICATIONS:              React.lazy(() => import('../pages/Certifications')),
  CHALLENGES:                  React.lazy(() => import('../pages/Challenges')),
  CLASSES:                     React.lazy(() => import('../pages/Classes')),
  COACH:                       React.lazy(() => import('../pages/SpiritualCoach')),
  CODEX:                       React.lazy(() => import('../pages/Codex')),
  CODEX_ORBITAL:               React.lazy(() => import('../pages/CodexOrbital')),
  COLLECTIVE_SHADOW_MAP:       React.lazy(() => import('../pages/CollectiveShadowMap')),
  COMMUNITY:                   React.lazy(() => import('../pages/Community')),
  CONSOLE:                     React.lazy(() => import('../pages/SovereignDashboard')),
  COSMIC_LEDGER:               React.lazy(() => import('../pages/CosmicLedger')),
  COSMIC_MAP:                  React.lazy(() => import('../pages/CosmicMap')),
  COSMIC_MIXER:                React.lazy(() => import('../pages/CosmicMixerPage')),
  COSMIC_STORE:                React.lazy(() => import('../pages/CosmicStore')),
  CREATE:                      React.lazy(() => import('../pages/Create')),
  CREATOR:                     React.lazy(() => import('../pages/CreatorDashboard')),
  CREATOR_CONSOLE:             React.lazy(() => import('../pages/ApexCreatorPage')),
  CRYPTIC_QUEST:               React.lazy(() => import('../pages/CrypticQuestNodes')),
  CRYSTAL_SKINS:               React.lazy(() => import('../pages/CrystalMarketplace')),
  CRYSTALLINE_ENGINE:          React.lazy(() => import('../pages/FractalEngine')),
  DAILY_BRIEFING:              React.lazy(() => import('../pages/DailyBriefing')),
  DANCE_MUSIC:                 React.lazy(() => import('../pages/DanceMusicStudio')),
  DIMENSIONAL_SPACE:           React.lazy(() => import('../pages/DimensionalSpace')),
  DISCOVER:                    React.lazy(() => import('../pages/TrySomethingNew')),
  DREAM_REALMS:                React.lazy(() => import('../pages/DreamRealms')),
  ECONOMY:                     React.lazy(() => import('../pages/EconomyPage')),
  ENLIGHTENMENT_OS:            React.lazy(() => import('../pages/EnlightenmentOS')),
  ENTANGLEMENT:                React.lazy(() => import('../pages/Entanglement')),
  EXERCISES:                   React.lazy(() => import('../pages/Exercises')),
  FABRICATOR:                  React.lazy(() => import('../pages/SovereignFabricator')),
  FORGOTTEN_LANGUAGES:         React.lazy(() => import('../pages/ForgottenLanguages')),
  FRACTAL_ENGINE:              React.lazy(() => import('../pages/FractalEngine')),
  FRIENDS:                     React.lazy(() => import('../pages/Friends')),
  GAMES:                       React.lazy(() => import('../pages/Games')),
  GRAVITY_WELL:                React.lazy(() => import('../pages/GravityWellExchange')),
  GREEN_JOURNAL:               React.lazy(() => import('../pages/GreenJournal')),
  GROWTH_TIMELINE:             React.lazy(() => import('../pages/GrowthTimeline')),
  HOOPONOPONO:                 React.lazy(() => import('../pages/Hooponopono')),
  HOTSPOTS:                    React.lazy(() => import('../pages/HotspotsPage')),
  JOURNEY:                     React.lazy(() => import('../pages/Journey')),
  LAB:                         React.lazy(() => import('../pages/SovereignLab')),
  LATTICE_VIEW:                React.lazy(() => import('../pages/LatticeView')),
  LEARN:                       React.lazy(() => import('../pages/Learn')),
  LIGHT_THERAPY:               React.lazy(() => import('../pages/LightTherapy')),
  LIQUIDITY_TRADER:            React.lazy(() => import('../pages/LiquidityTrader')),
  LIVE:                        React.lazy(() => import('../pages/LiveSessions')),
  MASTER_ENGINE:               React.lazy(() => import('../pages/SovereignMasterEngine')),
  MASTERY_AVENUES:             React.lazy(() => import('../pages/MasteryAvenues')),
  MASTERY_PATH:                React.lazy(() => import('../pages/MasteryPath')),
  MEAL_PLANNING:               React.lazy(() => import('../pages/MealPlanning')),
  MEDIA_LIBRARY:               React.lazy(() => import('../pages/UserUploads')),
  MEDITATION_HISTORY:          React.lazy(() => import('../pages/MeditationHistory')),
  MEMBERSHIP:                  React.lazy(() => import('../pages/MembershipLoom')),
  METATRON:                    React.lazy(() => import('../pages/FractalEngine')),
  MINT:                        React.lazy(() => import('../pages/MintingCeremony')),
  MINTING_CEREMONY:            React.lazy(() => import('../pages/MintingCeremony')),
  MY_CREATIONS:                React.lazy(() => import('../pages/MediaLibrary')),
  NEXUS:                       React.lazy(() => import('../pages/ElementalNexus')),
  NOURISHMENT:                 React.lazy(() => import('../pages/Nourishment')),
  OBSERVATORY:                 React.lazy(() => import('../pages/Observatory')),
  PHYSICS_LAB:                 React.lazy(() => import('../pages/SovereignLab')),
  PLANETARY_DEPTHS:            React.lazy(() => import('../pages/PlanetaryDepths')),
  PROFILE:                     React.lazy(() => import('../pages/ProfilePage')),
  READING_LIST:                React.lazy(() => import('../pages/ReadingList')),
  REFRACTOR:                   React.lazy(() => import('../pages/RefractorDemo')),
  REIKI:                       React.lazy(() => import('../pages/Reiki')),
  REPLANT:                     React.lazy(() => import('../pages/SovereignCanvasPage')),
  RESOURCE_ALCHEMY:            React.lazy(() => import('../pages/ResourceAlchemy')),
  ROCK_HOUNDING:               React.lazy(() => import('../pages/RockHounding')),
  RPG:                         React.lazy(() => import('../pages/RPGPage')),
  SEED_GALLERY:                React.lazy(() => import('../pages/SeedGalleryPage')),
  SETTINGS:                    React.lazy(() => import('../pages/Settings')),
  SOVEREIGN:                   React.lazy(() => import('../pages/SovereignArchitecture')),
  SOVEREIGN_CANVAS:            React.lazy(() => import('../pages/SovereignCanvasPage')),
  SOVEREIGN_CIRCLE:            React.lazy(() => import('../pages/SovereignCircle')),
  SOVEREIGNS:                  React.lazy(() => import('../pages/SovereignAdvisors')),
  SOVEREIGNTY:                 React.lazy(() => import('../pages/EnlightenmentOS')),
  SPIRITUAL_AVATAR:            React.lazy(() => import('../pages/SpiritualAvatarCreator')),
  STARSEED:                    React.lazy(() => import('../pages/Starseed')),
  STARSEED_REALM:              React.lazy(() => import('../pages/StarseedRealm')),
  STARSEED_WORLDS:             React.lazy(() => import('../pages/StarseedWorlds')),
  SUANPAN:                     React.lazy(() => import('../pages/SuanpanMixer')),
  TANTRA:                      React.lazy(() => import('../pages/Tantra')),
  THEORY:                      React.lazy(() => import('../pages/MusicTheory')),
  TRADE_ORBITAL:               React.lazy(() => import('../pages/TradeCircleOrbital')),
  TUTORIAL:                    React.lazy(() => import('../pages/Tutorial')),
  VIDEOS:                      React.lazy(() => import('../pages/Videos')),
  VOID:                        React.lazy(() => import('../pages/SilentSanctuary')),
  VR:                          React.lazy(() => import('../pages/VirtualReality')),
  WELLNESS_REPORTS:            React.lazy(() => import('../pages/WellnessReports')),
  WISDOM_JOURNAL:              React.lazy(() => import('../pages/WisdomJournal')),
  YANTRA:                      React.lazy(() => import('../pages/Yantra')),
};
