...
const SageVoiceCommand = lazy(() => import('./components/SageVoiceCommand'));
  ...
  return (
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes location={location}>
        ...
        <Route path="/pactola" element={<div style={{padding:'20px 16px', maxWidth:980, margin:'0 auto'}}><h1 style={{fontFamily:'Cormorant Garamond, serif', fontWeight:300, fontSize:'1.75rem'}}>Pactola Reservoir · Black Hills Bathymetry</h1><p style={{fontSize:11, letterSpacing:1.5, color:'var(--text-muted)', marginBottom:20}}>USGS-INFORMED PROCEDURAL TOPOGRAPHY · MAN-MADE 1956</p><BlackHillsBathymetry /></div>} />
        <Route path="/black-hills" element={<div style={{padding:'20px 16px', maxWidth:980, margin:'0 auto'}}><h1 style={{fontFamily:'Cormorant Garamond, serif', fontWeight:300, fontSize:'1.75rem'}}>Pactola Reservoir · Black Hills Bathymetry</h1><p style={{fontSize:11, letterSpacing:1.5, color:'var(--text-muted)', marginBottom:20}}>USGS-INFORMED PROCEDURAL TOPOGRAPHY · MAN-MADE 1956</p><BlackHillsBathymetry /></div>} />
        <Route path="/vault" element={<div style={{padding:'20px 16px', maxWidth:980, margin:'0 auto'}}><div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:12, flexWrap:'wrap'}}><div><h1 style={{fontFamily:'Cormorant Garamond, serif', fontWeight:300, fontSize:'1.75rem', margin:0}}>Tesseract Relic Vault</h1><p style={{fontSize:11, letterSpacing:1.5, color:'var(--text-muted)', marginBottom:20, marginTop:6}}>4D HYPERCUBE · HAWAIIAN IMPORTS · GOLDEN-SPIRAL DISTRIBUTION</p></div><Suspense fallback={null}><SageVoiceCommand size="compact" /></Suspense></div><TesseractVault /></div>} />
