    ...
    <motion.button
      ...
      <div className="flex items-start gap-2.5">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"
          style={{ background: `${option.color}15`, border: `1px solid ${option.color}20` }}>
          <div className="w-3 h-3 rounded-full" style={{ background: option.color, boxShadow: `0 0 8px ${option.color}40` }} />
        </div>
      ...
      <div className="aspect-square flex items-center justify-center relative overflow-hidden"
        ...
        {generating ? (
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-xs" style={{ color: '#C084FC' }}>Channeling cosmic energy...</p>
            <p className="text-[9px]" style={{ color: 'var(--text-muted)' }}>This may take 30-60 seconds</p>
          </div>
        ) : generatedAvatar ? (
          <img src={`data:image/png;base64,${generatedAvatar}`} alt="Spiritual Avatar"
            className="w-full h-full object-cover" />
        ) : (
          <div className="flex flex-col items-center gap-3 px-6 text-center">
            <User size={48} style={{ color: 'var(--text-muted)', opacity: 0.15 }} />
            ...
            <div className="mt-6 pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                ...
                style={{
                  ...
                  border: `1px solid ${hasSelections ? 'rgba(192,132,252,0.3)' : 'rgba(255,255,255,0.06)'}`,
                ...
                {generating ? (
                  ...
                  <><Sparkles size={16} /> Generate Spiritual Avatar</>
                )}
              </motion.button>
            </div>
          </div>
