...
const ROUTE_TO_MODULE = {
  ...
  // V1.1.1 — Bulk pillar wiring (98 routes). Every Hub pillar route now
  // pulls its page in-place via the matrix render slot. Zero new
  // adapter files; lazy-imports the existing pages directly.
  '/academy':              'ACADEMY',
  '/analytics':            'ANALYTICS',
  '/ar-portal':            'AR_PORTAL',
  '/archives':             'ARCHIVES',
  '/avatar-gallery':       'AVATAR_GALLERY',
  '/botany':               'BOTANY',
  '/botany-orbital':       'BOTANY_ORBITAL',
  '/certifications':       'CERTIFICATIONS',
  '/challenges':           'CHALLENGES',
  '/classes':              'CLASSES',
  '/coach':                'COACH',
  '/codex':                'CODEX',
  '/codex-orbital':        'CODEX_ORBITAL',
  '/collective-shadow-map': 'COLLECTIVE_SHADOW_MAP',
  '/community':            'COMMUNITY',
  '/console':              'CONSOLE',
  '/cosmic-ledger':        'COSMIC_LEDGER',
  '/cosmic-map':           'COSMIC_MAP',
  '/cosmic-mixer':         'COSMIC_MIXER',
  '/cosmic-store':         'COSMIC_STORE',
  '/create':               'CREATE',
  '/creator':              'CREATOR',
  '/creator-console':      'CREATOR_CONSOLE',
  '/cryptic-quest':        'CRYPTIC_QUEST',
  '/crystal-skins':        'CRYSTAL_SKINS',
  '/crystalline-engine':   'CRYSTALLINE_ENGINE',
  '/daily-briefing':       'DAILY_BRIEFING',
  '/dance-music':          'DANCE_MUSIC',
  '/dimensional-space':    'DIMENSIONAL_SPACE',
  '/discover':             'DISCOVER',
  '/dream-realms':         'DREAM_REALMS',
  '/economy':              'ECONOMY',
  '/enlightenment-os':     'ENLIGHTENMENT_OS',
  '/entanglement':         'ENTANGLEMENT',
  '/exercises':            'EXERCISES',
  '/fabricator':           'FABRICATOR',
  '/forgotten-languages':  'FORGOTTEN_LANGUAGES',
  '/fractal-engine':       'FRACTAL_ENGINE',
  '/friends':              'FRIENDS',
  '/games':                'GAMES',
  '/gravity-well':         'GRAVITY_WELL',
  '/green-journal':        'GREEN_JOURNAL',
  '/growth-timeline':      'GROWTH_TIMELINE',
  '/hooponopono':          'HOOPONOPONO',
  '/hotspots':             'HOTSPOTS',
  '/journey':              'JOURNEY',
  '/lab':                  'LAB',
  '/lattice-view':         'LATTICE_VIEW',
  '/learn':                'LEARN',
  '/light-therapy':        'LIGHT_THERAPY',
  '/liquidity-trader':     'LIQUIDITY_TRADER',
  '/live':                 'LIVE',
  '/master-engine':        'MASTER_ENGINE',
  '/mastery-avenues':      'MASTERY_AVENUES',
  '/mastery-path':         'MASTERY_PATH',
  '/meal-planning':        'MEAL_PLANNING',
  '/media-library':        'MEDIA_LIBRARY',
  '/meditation-history':   'MEDITATION_HISTORY',
  '/membership':           'MEMBERSHIP',
  '/metatron':             'METATRON',
  '/mint':                 'MINT',
  '/minting-ceremony':     'MINTING_CEREMONY',
  '/my-creations':         'MY_CREATIONS',
  '/nexus':                'NEXUS',
  '/nourishment':          'NOURISHMENT',
  '/observatory':          'OBSERVATORY',
  '/physics-lab':          'PHYSICS_LAB',
  '/planetary-depths':     'PLANETARY_DEPTHS',
  '/profile':              'PROFILE',
  '/reading-list':         'READING_LIST',
  '/refractor':            'REFRACTOR',
  '/reiki':                'REIKI',
  '/replant':              'REPLANT',
  '/resource-alchemy':     'RESOURCE_ALCHEMY',
  '/rock-hounding':        'ROCK_HOUNDING',
  '/rpg':                  'RPG',
  '/seed-gallery':         'SEED_GALLERY',
  '/settings':             'SETTINGS',
  '/sovereign':            'SOVEREIGN',
  '/sovereign-canvas':     'SOVEREIGN_CANVAS',
  '/sovereign-circle':     'SOVEREIGN_CIRCLE',
  '/sovereigns':           'SOVEREIGNS',
  '/sovereignty':          'SOVEREIGNTY',
  '/spiritual-avatar':     'SPIRITUAL_AVATAR',
  '/starseed':             'STARSEED',
  '/starseed-realm':       'STARSEED_REALM',
  '/starseed-worlds':      'STARSEED_WORLDS',
  '/suanpan':              'SUANPAN',
  '/tantra':               'TANTRA',
  '/theory':               'THEORY',
  '/trade-orbital':        'TRADE_ORBITAL',
  '/tutorial':             'TUTORIAL',
  '/videos':               'VIDEOS',
  '/void':                 'VOID',
  '/vr':                   'VR',
  '/wellness-reports':     'WELLNESS_REPORTS',
  '/wisdom-journal':       'WISDOM_JOURNAL',
  '/yantra':               'YANTRA',
};
