...
const FAQS = [
  ...
  { q: "What are Solfeggio Frequencies?", a: "Ancient resonant tones (174-963 Hz) believed to support spiritual wellbeing and inner alignment. Each frequency attunes a different energy center. Access them through Quick Reset or the Frequencies page.", category: "wisdom" },
...
const TUTORIALS = [
  ...
  { title: "Crystal Resonance", desc: "Discover your crystal matches", path: "/crystals", icon: Gem, color: "#8B5CF6" },
