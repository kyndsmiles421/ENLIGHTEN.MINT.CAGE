...
const FAQS = [
  ...
  { q: "Can I use this app offline?", a: "The Cosmic Collective is a Progressive Web App (PWA). Core pages work offline after first load. AI features, community features, and real-time data require an internet connection.", category: "technical" },
