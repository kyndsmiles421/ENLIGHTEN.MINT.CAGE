...
import {
  EnergyBar, DepthLayer, SpecimenCard, CollectionItem,
...
import {
  ...
  BookOpen, RefreshCw, Crown, Sparkles, Star
} from 'lucide-react';
      ...
      <div className="pb-40" data-testid="rock-hounding-page">
        ...
        <div className="px-4 pt-4 pb-3 flex items-center gap-3">
          <button onClick={() => navigate(-1)} className="w-8 h-8 rounded-lg flex items-center justify-center"
            style={{ background: 'rgba(255,255,255,0.03)', touchAction: 'manipulation' }} data-testid="rh-back-btn">
          ...
          <div className="flex items-center gap-1.5">
            <button onClick={() => navigate('/nexus')} className="text-[8px] px-2 py-1 rounded-lg"
              style={{ background: `${biomeColor}06`, color: biomeColor, border: `1px solid ${biomeColor}10`, touchAction: 'manipulation' }}
              data-testid="rh-nexus-link">Nexus</button>
            <button onClick={() => navigate('/rpg')} className="text-[8px] px-2 py-1 rounded-lg"
              style={{ background: 'rgba(129,140,248,0.06)', color: '#818CF8', border: '1px solid rgba(129,140,248,0.1)', touchAction: 'manipulation' }}
          ...
          {tab === 'mine' && (
            <>
              ...
              <button onClick={resetMine}
                ...
                style={{ background: 'rgba(59,130,246,0.04)', color: '#3B82F6', border: '1px solid rgba(59,130,246,0.08)', touchAction: 'manipulation' }}
