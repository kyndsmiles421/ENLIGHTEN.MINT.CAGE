...
export default function Journal() {
  ...
  return (
    <div className="min-h-screen immersive-page shadow-void-container px-6 md:px-12 lg:px-24 py-12" style={{ background: '#000000', paddingTop: '80px' }} data-testid="journal-page">
