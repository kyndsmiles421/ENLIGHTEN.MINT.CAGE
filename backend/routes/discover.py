...
ALL_FEATURES = [
    ...
    {"id": "aromatherapy", "name": "Aromatherapy", "path": "/aromatherapy", "category": "healing", "color": "#C084FC",
     "desc": "Essential oils for chakra alignment and emotional balance", "db_collection": "aroma_favorites"},
    {"id": "herbology", "name": "Herbology", "path": "/herbology", "category": "healing", "color": "#22C55E",
    ...
    {"id": "acupressure", "name": "Acupressure", "path": "/acupressure", "category": "healing", "color": "#EF4444",
    ...
    {"id": "reiki", "name": "Reiki & Aura", "path": "/reiki", "category": "energy", "color": "#818CF8",
     "desc": "Energy healing, aura readings, and chakra alignment", "db_collection": "reiki_sessions"},
    ...
    {"id": "mantras", "name": "Mantras", "path": "/mantras", "category": "sound", "color": "#FB923C",
     "desc": "Sacred chants for vibrational healing", "db_collection": "custom_mantras"},
    ...
    {"id": "frequencies", "name": "Frequencies", "path": "/frequencies", "category": "sound", "color": "#8B5CF6",
     "desc": "Solfeggio and binaural healing frequencies", "db_collection": None},
    {"id": "light_therapy", "name": "Light Therapy", "path": "/light-therapy", "category": "senses", "color": "#A855F7",
     "desc": "Chromotherapy colors for chakra healing", "db_collection": None},
...
async def get_suggestions(user=Depends(get_current_user)):
    ...
    used = [f for f in ALL_FEATURES if f["id"] in used_features]
