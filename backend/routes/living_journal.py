...
async def _generate_discovery_narrative(specimen: dict, meta: dict, context: dict) -> str:
    ...
    try:
        ...
        llm = LlmChat(
            ...
            system_message="You are the Living Journal of The ENLIGHTEN.MINT.CAFE — a mystical geology-based Information · Entertainment · Education · Gamification experience. Write brief, evocative, poetic journal entries.",
