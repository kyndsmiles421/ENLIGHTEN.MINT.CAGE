...
# ─── Tier & Pricing Config ───────────────────────────────────────────────
# Geological-themed tiers: Sedimentary (Free) → Igneous (Premium) → Metamorphic (Elite)
TIERS = {
    "free": {
        "name": "Sedimentary",
        "price": 0,
        ...
        "interval": "month",
        "decay_paused": False,
        "perks": ["50 AI credits/month", "Full basic site access", "Wellness tracking", "Star Chart", "Trade Circle", "Common stone discovery (Silica, Quartz, Sandstone)", "Seed-level spiritual teachings"],
    },
    "starter": {
        "name": "Starter",
        "price": 4.99,
        ...
        "interval": "month",
        "decay_paused": False,
        "perks": ["100 AI credits/month", "Everything in Sedimentary", "Double the AI allowance"],
    },
    "plus": {
        "name": "Igneous",
        "price": 9.99,
        ...
        "perks": [
            ...
            "Rare high-energy stones (Obsidian, Moldavite)",
            "Advanced 963 Hz soundscapes in Cosmic Mixer",
            "Root through Branch level teachings",
    ...
    "premium": {
        ...
        "perks": [
            "Unlimited AI usage",
            "Everything in Igneous",
            "Early access to Seasonal Shifts",
            "Physical-to-digital Starter Kit eligible",
            "Canopy level wisdom contribution",
            "Sora Video Generation",
            "AI Sage Voice Sessions",
            "Dream Journal with AI Interpretation",
            "Personal Cosmic Calendar",
            "Export & Download Everything",
            "Metamorphic badge + crystalline aura",
        ],
    },
    "super_user": {
        "name": "Super User",
