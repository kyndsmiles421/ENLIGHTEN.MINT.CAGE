...
CONSTELLATIONS = [
    {"id": "aries", "name": "Aries", "symbol": "Ram", "element": "Fire", "ra": 2.0, "dec": 20.0,
     ...
     "mythology": {"figure": "The Golden Ram", "origin": "Greek", "deity": "Zeus", "story": "Chrysomallus, the winged ram with fleece of pure gold, was sent by Zeus to rescue the children Phrixus and Helle from their cruel stepmother. Flying across the sky, the ram carried them to safety. Its golden fleece later became the prize sought by Jason and the Argonauts — a symbol of authority and kingship.", "lesson": "Sometimes salvation arrives in the most unexpected forms. The courage to accept rescue is itself an act of bravery."}},
    {"id": "taurus", "name": "Taurus", "symbol": "Bull", "element": "Earth", "ra": 4.5, "dec": 16.0,
     ...
     "mythology": {"figure": "The Celestial Bull", "origin": "Greek / Mesopotamian", "deity": "Zeus / Gugalanna", "story": "Zeus transformed himself into a magnificent white bull to win the heart of Europa, the Phoenician princess. She was so enchanted by the gentle beast that she climbed upon his back — and he carried her across the sea to Crete. In Mesopotamia, Taurus was Gugalanna, the Bull of Heaven, sent to punish Gilgamesh.", "lesson": "True strength is gentle. The most powerful forces move with patience, not haste."}},
    {"id": "gemini", "name": "Gemini", "symbol": "Twins", "element": "Air", "ra": 7.0, "dec": 22.0,
     ...
     "mythology": {"figure": "The Divine Twins", "origin": "Greek", "deity": "Castor & Pollux", "story": "Castor and Pollux were twin brothers — one mortal, one divine. When Castor was slain in battle, Pollux begged Zeus to let him share his immortality. Moved by this love, Zeus placed them both in the heavens as eternal companions. Sailors invoked the twins for protection, seeing their light as St. Elmo's fire.", "lesson": "The deepest bonds transcend even death. Love shared between souls becomes eternal."}},
    {"id": "cancer", "name": "Cancer", "symbol": "Crab", "element": "Water", "ra": 8.5, "dec": 12.0,
     ...
     "mythology": {"figure": "The Sacred Crab", "origin": "Greek", "deity": "Hera", "story": "During Heracles' battle with the fearsome Hydra, Hera sent a giant crab to distract the hero and aid her champion. Though Heracles crushed it underfoot, Hera honored the crab's loyalty by placing it among the stars. The Praesepe star cluster within Cancer was known as 'The Manger' — a place of cosmic nourishment.", "lesson": "Even the smallest act of loyalty is honored by the universe. Devotion has its own immortality."}},
    {"id": "leo", "name": "Leo", "symbol": "Lion", "element": "Fire", "ra": 10.5, "dec": 15.0,
     ...
     "mythology": {"figure": "The Nemean Lion", "origin": "Greek", "deity": "Heracles", "story": "The Nemean Lion was an invulnerable beast whose golden fur could not be pierced by any weapon. Heracles, as his first labor, wrestled the lion and defeated it with bare hands. He wore its pelt as armor for the rest of his journeys. Regulus, the heart star, was called 'The Little King' — the star that ruled all others.", "lesson": "The greatest obstacles require not greater weapons, but greater courage and creativity."}},
    {"id": "virgo", "name": "Virgo", "symbol": "Maiden", "element": "Earth", "ra": 13.0, "dec": -4.0,
     ...
     "mythology": {"figure": "The Harvest Maiden", "origin": "Greek / Egyptian", "deity": "Demeter / Isis", "story": "Virgo is associated with Demeter, goddess of the harvest, who held a sheaf of wheat — represented by the brilliant star Spica. When her daughter Persephone was taken to the underworld, Demeter's grief caused winter. In Egypt, Virgo was Isis, the great mother goddess, whose tears of sorrow for Osiris caused the Nile to flood and bring fertility.", "lesson": "From great love comes great grief, and from grief comes the renewal of all living things."}},
    {"id": "libra", "name": "Libra", "symbol": "Scales", "element": "Air", "ra": 15.0, "dec": -15.0,
     ...
     "mythology": {"figure": "The Scales of Justice", "origin": "Egyptian / Greek", "deity": "Ma'at / Astraea", "story": "In Egyptian mythology, the scales belonged to Ma'at, goddess of truth. After death, every soul's heart was weighed against her feather. Only the pure of heart could enter the afterlife. The Greeks associated Libra with Astraea, the star goddess of justice, who was the last immortal to leave Earth during the decline of humanity.", "lesson": "True justice begins within. Balance your own heart before you weigh the world."}},
    {"id": "scorpio", "name": "Scorpio", "symbol": "Scorpion", "element": "Water", "ra": 16.5, "dec": -26.0,
     ...
     "mythology": {"figure": "The Great Scorpion", "origin": "Greek", "deity": "Artemis / Gaia", "story": "When the hunter Orion boasted he would slay every creature on Earth, Gaia sent a giant scorpion to humble him. The scorpion's sting was fatal even to the mighty hunter. Zeus placed both in opposite sides of the sky — as Scorpio rises, Orion sets, eternally chasing but never catching each other. Antares, the red heart star, means 'Rival of Mars.'", "lesson": "Hubris invites its own downfall. Respect the forces greater than yourself."}},
    {"id": "sagittarius", "name": "Sagittarius", "symbol": "Archer", "element": "Fire", "ra": 19.0, "dec": -25.0,
     ...
     "mythology": {"figure": "The Centaur Archer", "origin": "Greek", "deity": "Chiron", "story": "Chiron was the wisest of all centaurs — a healer, teacher, and prophet who tutored Achilles, Heracles, and Asclepius. Unlike other centaurs who were wild and chaotic, Chiron embodied the union of animal instinct and divine wisdom. His arrow points toward the galactic center — the heart of the Milky Way itself.", "lesson": "The greatest teacher is the wounded healer. Wisdom comes from integrating both our wild nature and our higher self."}},
    {"id": "capricorn", "name": "Capricorn", "symbol": "Sea-Goat", "element": "Earth", "ra": 21.0, "dec": -18.0,
     ...
     "mythology": {"figure": "The Sea-Goat", "origin": "Sumerian / Greek", "deity": "Enki / Pan", "story": "The sea-goat is one of the oldest constellation figures, dating to ancient Sumer where it represented Enki, god of wisdom and the deep waters. In Greek myth, Pan — god of the wild — leaped into the Nile to escape the monster Typhon, transforming his lower half into a fish while his upper body remained a goat. This dual nature symbolizes mastery of both earthly ambition and spiritual depths.", "lesson": "True mastery means being comfortable in all realms — the mountain peak and the ocean deep."}},
    {"id": "aquarius", "name": "Aquarius", "symbol": "Water Bearer", "element": "Air", "ra": 22.5, "dec": -10.0,
     ...
     "mythology": {"figure": "The Water Bearer", "origin": "Greek / Sumerian", "deity": "Ganymede / Ea", "story": "Ganymede was a beautiful Trojan youth so fair that Zeus himself fell in love and carried him to Olympus on the back of an eagle (Aquila) to serve as cupbearer to the gods. His pouring of celestial water represents the flow of divine knowledge to humanity. In the Age of Aquarius, this water becomes the stream of awakened consciousness.", "lesson": "You carry within you the water of life. Pour it freely — what you give to the world returns to you multiplied."}},
    {"id": "pisces", "name": "Pisces", "symbol": "Fish", "element": "Water", "ra": 0.5, "dec": 8.0,
     ...
     "mythology": {"figure": "The Bound Fish", "origin": "Greek / Babylonian", "deity": "Aphrodite & Eros", "story": "When the terrible Typhon attacked Olympus, Aphrodite and her son Eros transformed into fish and leaped into the Euphrates to escape. They tied themselves together with a cord so they would never be separated. The two fish swimming in opposite directions represent the eternal pull between the material and spiritual worlds — forever connected, forever seeking.", "lesson": "The bond of love is stronger than any transformation. Even in our deepest changes, we remain connected to those we love."}},
    ...
    {"id": "orion", "name": "Orion", "symbol": "Hunter", "element": "Fire", "ra": 5.5, "dec": 0.0,
     ...
     "mythology": {"figure": "The Great Hunter", "origin": "Greek / Egyptian", "deity": "Orion / Osiris", "story": "Orion was the greatest hunter who ever lived — a giant so tall he could walk across the ocean floor with his head above the waves. He was beloved by Artemis, goddess of the hunt. But jealous Apollo tricked Artemis into killing Orion with an arrow. Grief-stricken, she placed him among the stars. In Egypt, Orion was Osiris, lord of the afterlife, and his belt stars aligned with the pyramids of Giza.", "lesson": "Even the mightiest among us are humbled by fate. But love immortalizes what death cannot touch."}},
    {"id": "ursa_major", "name": "Ursa Major", "symbol": "Great Bear", "element": "Earth", "ra": 11.0, "dec": 55.0,
     ...
     "mythology": {"figure": "The Great Bear", "origin": "Greek / Native American", "deity": "Callisto / Great Spirit", "story": "Callisto was a beautiful nymph and companion of Artemis. When Zeus seduced her, jealous Hera transformed Callisto into a bear. Years later, her son Arcas nearly killed her during a hunt. Zeus intervened, placing both mother and son in the sky as Ursa Major and Ursa Minor. Native Americans saw the Big Dipper as a great bear pursued by hunters through the cosmic forest.", "lesson": "A mother's love endures every transformation. Even when we cannot recognize those we love, the bond remains."}},
    {"id": "lyra", "name": "Lyra", "symbol": "Lyre", "element": "Air", "ra": 18.9, "dec": 36.0,
     ...
     "mythology": {"figure": "Orpheus's Lyre", "origin": "Greek", "deity": "Orpheus / Hermes", "story": "The lyre was crafted by Hermes from a tortoise shell and given to Apollo, who passed it to Orpheus — the greatest musician who ever lived. His music could charm wild beasts, make rivers stop flowing, and move stones to tears. When his beloved Eurydice died, Orpheus descended to the underworld and played so beautifully that even Hades wept. Vega, its brightest star, was the ancient Pole Star and will be again in 12,000 years.", "lesson": "Art is the bridge between worlds. Music speaks the language that words cannot reach."}},
    {"id": "cygnus", "name": "Cygnus", "symbol": "Swan", "element": "Water", "ra": 20.5, "dec": 42.0,
     ...
     "mythology": {"figure": "The Celestial Swan", "origin": "Greek", "deity": "Zeus / Orpheus", "story": "Zeus disguised himself as a swan to visit Leda, from which union Helen of Troy was born. But the deeper myth connects Cygnus to Orpheus — after his death, his soul was placed among the stars as a swan, flying eternally along the Milky Way beside his beloved lyre (Lyra). Deneb, its tail star, is one of the most luminous stars visible to the naked eye — 200,000 times brighter than our Sun.", "lesson": "Transformation is the soul's natural flight. What appears as an ending is merely a change of form."}},
]
