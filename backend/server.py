...
@api_router.get("/animal-totems/all")
...
@api_router.get("/animal-totems/birth")
...
@api_router.get("/animal-totems/spirit/{animal_id}")
...
@api_router.delete("/green-journal/{entry_id}")
